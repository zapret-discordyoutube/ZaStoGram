...
public final class ProxySettings {
     ...
     */
    /**
     * ZaStoGram: a WEB proxy from raw user input or a link, normalized the way
     * upstream does it (host[/path], marked secret for a path), or null when
     * it is not a valid WEB proxy.
     */
    public static ProxySettings webProxy(String address, String secret) {
        final ProxySettings settings = builder()
                .setType(Type.WEB)
                .setAddress(address)
                .setPort(0)
